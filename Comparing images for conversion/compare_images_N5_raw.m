function compare_images_N5_raw(before,after,tags,finalfile)
...
z=size(after,1)/2;
for t=1:z;
     G_N4(1,g)=mean2(data.raw.afternonrecorded4{1,h});  
    h=h+2
    g=g+1
end
...
p=size(after,1)/2;  
for s=1:p;
    R_N4(1,j)=mean2(data.raw.afternonrecorded4{1,o});
    j=j+1
    o=o+2
end
...
save (['Compare Images Time Series Raw Data for 5 neurons' finalfile '.mat']); 
