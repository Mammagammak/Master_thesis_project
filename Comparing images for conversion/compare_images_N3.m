function compare_images_N3(before,after,tags,finalfile)
...
save (['Compare Images Time series normalized for each condition for 3 neurons_' finalfile '.mat']); 
x=[10 30 80 180 330 880 1530 2380 3430];
plot(x,G,'m-o',x,R,'b-o',x,G_N,'g--',x,R_N,'r--',x,G_difference,'y--',x,R_difference,'k--',x,G_N2,'g--',x,R_N2,'r--');
title('After/Before concersion rate');
