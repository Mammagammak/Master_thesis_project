function KL_plot_nr_freq_vary_pchip(before,after,tags,finalfile)
%% this function analyzes the data using the Piecewise Cubic Hermite Interpolating Polynomial model (Pchip)

close all
% this section is useful while debugging to prevent entering values over
% and over again
if (nargin < 1)
% example of 250 spikes interval varying condition  
before = {'180702_E4_img_000000001_Default_000.tif';'180702_E4_img_000000002_Default_000.tif'};
after={'180702_E4_img_000000004_Default_000.tif';'180702_E4_img_000000003_Default_000.tif';'180702_E4_img_000000006_Default_000.tif';'180702_E4_img_000000005_Default_000.tif';'180702_E4_img_000000008_Default_000.tif';'180702_E4_img_000000007_Default_000.tif';'180702_E4_img_000000010_Default_000.tif';'180702_E4_img_000000009_Default_000.tif';'180702_E4_img_000000012_Default_000.tif';'180702_E4_img_000000011_Default_000.tif'};
tags={'Green';'Red'};
finalfile=('180702_E4');    
...
roi_recordedneuron_columns=[274 293];
roi_recordedneuron_rows=[452 495];
recorded_distance=0;


roi_nonrecordedneuron_columns=[236 266];
roi_nonrecordedneuron_rows=[483 511];
nonrecorded_distance=26.4;

roi_nonrecordedneuron2_columns=[318 369];
roi_nonrecordedneuron2_rows=[210 235];
nonrecorded2_distance=228.98;

roi_nonrecordedneuron3_columns=[20 41];
roi_nonrecordedneuron3_rows=[303 337];
nonrecorded3_distance=274.11;

roi_nonrecordedneuron4_columns=[347 379];
roi_nonrecordedneuron4_rows=[1 34];
nonrecorded4_distance=429.1;
...
Spike_count=input('How many spikes were initiated for each condition? (e.g:250 or 450 or 650...)=');

roi_recordedneuron_columns=input('enter the columns of the region of the recorded neuron to analyze in an array. Exp:[x0 x1] = ');
roi_recordedneuron_rows=input('enter the rows of the region of the recorded neuron to analyze in an array. e.g:[y0 y1] = ');
...
roi_nonrecordedneuron_rows=input('enter the rows of the region of non-recorded neuron to analyze in an array. e.g:[y0 y1] = ');
...
roi_nonrecordedneuron2_rows=input('enter the rows of the region of the second non-recorded neuron to analyze in an array. e.g:[y0 y1] = ');
...
roi_nonrecordedneuron3_rows=input('enter the rows of the region of the third non-recorded neuron to analyze in an array. e.g:[y0 y1] = ');
...
roi_nonrecordedneuron4_rows=input('enter the rows of the region of the fourth non-recorded neuron to analyze in an array. e.g:[y0 y1] = ');
...
% creating the spike vector to work with 
s=zeros(1,5);
k=1;
for i=Spike_count:Spike_count:(5*Spike_count)
    s(k)=i;
    k=k+1;
end
